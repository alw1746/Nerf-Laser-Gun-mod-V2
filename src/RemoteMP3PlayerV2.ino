...
#include "printf.h"
#include "Button.h"
#define WEAPON_SELECT 8     //self-test weapon select button
...
SoftwareSerial Serial1(4, 5);          // RX, TX to dfplayer module
...
const byte pinDfpBusy = 14;            //Arduino pin -> dfplayer BUSY pin 16 (low: playing / high: not playing)

void setup()
{
  Serial.begin(57600);     //serial monitor
  Serial1.begin(9600);     //software serial1 port
